...
import QueryProvider from "@/components/QueryProvider";  // Add this import
...
export default function RootLayout({
  ...
  return (
    <QueryProvider>  {/* Add this wrapper */}
      <html lang="en">
        <head>
          <title>Motors - Premium Car Dealership</title>
          <meta name="description" content="Premium car dealership" />
          <meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover" />
        </head>
        <body className={inter.className} style={{ background: "#000000", margin: 0, padding: 0 }}>
          <main style={{ 
            maxWidth: "1200px", 
            margin: "0 auto", 
